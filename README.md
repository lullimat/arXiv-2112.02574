...
Welcome to the repository related to the paper [https://arxiv.org/abs/2112.02574](https://arxiv.org/abs/2112.02574).

A Jupyter Notebook that can be used to reproduce the results will soon be uploaded to the repository.
In order to execute it is necessary to install the [idea.deploy](https://github.com/lullimat/idea.deploy) framework.

In order to open the present Jupyter notebook "MultiComponentMesoscopicTolmanLength.ipynb" you should perform the following steps
...
- click the file "MultiComponentMesoscopicTolmanLength.ipynb"
...
As of today, after much testing Firefox and Google Chrome have offered the most reliable expreience in handling the notebook.

At your first time, please execute the cells in order starting from the top and following the instructions.
